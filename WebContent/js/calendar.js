...
Calendar.construct = function() {
	...
	this.show = function(e, tp) {
        ...
        iframe.style.pixelHeight = obj.offsetHeight+3;
...
//		fieldset.style.filter ="progid:DXImageTransform.Microsoft.Shadow ( enabled=t , color=#D4D4D4 , direction=135 , strength=2)";
...
//		legend.style.fontSize = 12;
		...
		table.style.filter ="progid:DXImageTransform.Microsoft.Shadow ( enabled=t , color=#D4D4D4 , direction=135 , strength=2)";
		that.tableContent(year, month);
//		fieldset.appendChild(legend);
		fieldset.style.paddingTop = 5;
		fieldset.style.paddingBottom = 3;
...
//			this.style.backgroundColor = '#FFFFFE';
	...
	this.setValue = function() {
		...
		}else 
		{
			...
			{
				inp.innerText = year + '-' + month + '-' + day + ' ' + hour + ':' + minute;
			}
		}
	};
