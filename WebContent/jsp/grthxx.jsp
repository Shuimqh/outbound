...
<html>
  ...
  <link href="css/index4.css" rel="stylesheet" type="text/css" media="all">
...
<body>    
	<div class="abc">  
        <input type="hidden" id="p1" value="<s:property value="p1" />" name="p1">
	    <input type="hidden" id="p2" value="<s:property value="p2" />" name="p2">
