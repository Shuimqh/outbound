...
String d1=formatter.format(new Date());
SimpleDateFormat formatter2 = new SimpleDateFormat("MM");
String d2=formatter2.format(new Date());
...
File url1 = new File(savePath+d1);
			if (!url1.exists()) {
				url1.mkdirs();
			}
			File url2 = new File(savePath+d1+"/"+d2);
			if (!url2.exists()) {
				url2.mkdirs();
			}			

savePath=savePath+d1+"/"+d2+"/";
saveUrl=saveUrl+d1+"/"+d2+"/";
//定义允许上传的文件扩展名
