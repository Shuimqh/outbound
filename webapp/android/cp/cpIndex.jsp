...
<div class="container">
	<div class="head">
   	...
   	<div>   	
		...
		<div class="right">
   		<div class="lr">
	  	 <img src="images/u_b.gif" border="0" /><span class="bt">产品管理</span>  <a href="addCp.action" >新增</a>
		</div>
				...
				<s:iterator value="list1" status="number">
					...
					<tr
						...
						<td>
							...
							<a href="getNews.action?id=<s:property value="id" />" target="_blank" >查询</a>
						</td>
						<td>
							<a href="delNews.action?id=<s:property value="id" />">删除</a>
							<a href="editNews.action?id=<s:property value="id" />">修改</a>
		...
		<form id="form_kack" action="inback.action" method="post" name="form_kack"/>
		</div>
		</div>
